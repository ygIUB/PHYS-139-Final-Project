...
class InstanceSegmentationMetrics:
    ...
    def match_instances(iou_matrix, iou_threshold=0.5):
        ...
        # Using Hungarian algorithm for optimal matching
    ...
    def compute_f1_at_threshold(pred_mask, gt_mask, iou_threshold=0.5):
        ...
        # Computing IoU matrix and match
    ...
    def compute_average_precision_at_threshold(pred_mask, gt_mask, iou_threshold=0.5):
        ...
        # Calculating precision (which equals AP for binary predictions)
        tp = len(matches)
        fp = len(unmatched_pred)
...
class ValidationBenchmark:
    ...
    def save_results(self):
        ...
        # Calculating and save statistics
...
def main():
    ...
    print("---OURRESUNET/BASELINE U-NET VALIDATION BENCHMARK---")
    ...
    # Option 1: Benchmark OurResUNet
    MODEL_PATH = "../model/U-RNet+_gpu_10ep.keras"  # Modify this path to the saved model
    MODEL_NAME = "OurResUNet"  # Change to "Baseline U-Net" if benchmarking baseline

    # Option 2: Benchmark Baseline U-Net (uncomment to use)
    # MODEL_PATH = "../model/baseline_unet.keras"
    # MODEL_NAME = "Baseline U-Net"

    NPY_PATH = "../npydata"
    OUTPUT_DIR = "./benchmark_results_ourresunet"  # Change for different models
